...
const ViewNotificationRequest: React.FC<ViewNotificationRequestProps> = ({
  notification,
  onApprove,
  onReject,
}) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h2 className="text-lg font-semibold text-[#2F3140] mb-2">
          Notification Creation Request Approved
        </h2>
        <p className="text-sm text-[#707781] mb-8 text-center">
          Notification creation was successfully approved.
        </p>
        <div className="w-32">
          <Button
            text="Done"
  ...
  if (viewStatus === "rejected") {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <h2 className="text-lg font-semibold text-[#2F3140] mb-2">
          Notification Creation Request Rejected
        </h2>
        <p className="text-sm text-[#707781] mb-8 text-center">
          Notification request was successfully rejected.
        </p>
        <div className="w-32">
          <Button
            text="Done"
  ...
  return (
    <div className="flex flex-col h-full">
      <ApproveModal
        ...
        description="Are you sure you want to approve this notification request?"
      />
      <RejectModal
...
export default ViewNotificationRequest;
