...
const CustomCheckbox = ({
  ...
  <div className="flex items-center gap-3 cursor-pointer group select-none" onClick={onChange}>
    <div
      className={`relative w-6 h-6 rounded border-2 transition-all duration-200 ${
